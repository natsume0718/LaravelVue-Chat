                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="relative w-full mb-3">
                                ...
                                <input type="text" name="name" id="username" value="{{ old('name') }}"
                                    ...
                                    placeholder="User Name" style="transition: all 0.15s ease 0s;" required autofocus>
                                @error('name')
                            ...
                            <div class="relative w-full mb-3">
                                ...
                                <input type="password" id="password_confirm" name="password_confirmation"
                                    class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
                                    placeholder="Confirmation Password" style="transition: all 0.15s ease 0s;" required
                                    autocomplete="new-password">
